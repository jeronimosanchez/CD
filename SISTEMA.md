...
Una consecuencia deliberada de este diseño: **el conocimiento se acumula en el sistema —en la
organización—, no solo en las personas**. El criterio de diseño, las reglas de plataforma y cada
arreglo validado quedan capturados en la `kb`, no únicamente en la cabeza de quien los descubrió.
